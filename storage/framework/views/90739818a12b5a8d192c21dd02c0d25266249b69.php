        ...
        <div class="col-lg-8 content-area mb-4">
            <div class="card h-100">
                ...
                <div class="card-body" id="lesson-content-area">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <img src="<?php echo e(asset('storage/' . $training->image)); ?>"  alt="<?php echo e($training->title); ?>" class="img-fluid rounded mb-3">
                        </div>
                        <div class="col-md-7">
                            ...
                            <p><strong>Catégorie:</strong> <?php echo e($training->category->name); ?></p>
