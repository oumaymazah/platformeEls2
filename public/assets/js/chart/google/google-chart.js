...
function drawBasic() {
  if ($("#column-chart1").length > 0) {
      ...
      b = {
        ...
        height: 400,
        width:'100%',
          colors: [vihoAdminConfig.primary, vihoAdminConfig.primary, " #2B6ED4"]
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: [vihoAdminConfig.primary, vihoAdminConfig.primary, " #2B6ED4", "#222222", "#717171"]
      };
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: [vihoAdminConfig.primary, vihoAdminConfig.secondary, " #2B6ED4", "#222222", "#717171"]
      };
  ...
  if ($("#pie-chart3").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: [vihoAdminConfig.secondary, vihoAdminConfig.primary, "#222222", "#717171", " #2B6ED4"]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: [vihoAdminConfig.primary, vihoAdminConfig.secondary, "#222222", "#717171", " #2B6ED4", "#d22d3d","#ADD8E633", vihoAdminConfig.primary, vihoAdminConfig.secondary, "#222222", "#717171", " #2B6ED4","#d22d3d", vihoAdminConfig.primary, vihoAdminConfig.secondary, "#222222", "#717171", " #2B6ED4", "#d22d3d", vihoAdminConfig.primary,vihoAdminConfig.secondary, "#222222"]
        };
