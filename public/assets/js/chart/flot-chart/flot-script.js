        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [vihoAdminConfig.primary, "#ba895" ,"#222222" ,"#717171" ," #2B6ED4", "#d22d3d" ,"#ADD8E633"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            ...
            {color: " #2B6ED4", points: data3_points, data: data4_errors}
            ];
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [vihoAdminConfig.primary, "#ba895" ,"#222222" ,"#717171" ," #2B6ED4", "#d22d3d" ,"#efefef"]
    });
